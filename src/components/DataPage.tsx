  ...
  return (
    <div className="page-container">
      <div className="sub-nav">
        <button className={`sub-nav-btn ${subTab === 'QUESTS' ? 'active' : ''}`} onClick={() => handleTabClick('QUESTS')}>QUESTS</button>
        <button className={`sub-nav-btn ${subTab === 'WORKSHOPS' ? 'active' : ''}`} onClick={() => handleTabClick('WORKSHOPS')}>WORKSHOPS</button>
      </div>

      {subTab === 'QUESTS' && (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div className="quest-list" style={{ flex: 1, overflowY: 'auto', paddingRight: '5px' }}>
          <div className="quest-item" style={{ borderColor: 'var(--pipboy-green)', boxShadow: '0 0 5px var(--pipboy-green-glow)', marginBottom: '1.5rem' }}>
             ...
             <div className="quest-desc" style={{ marginTop: '0.5rem', fontSize: '1.15rem' }}>
               ...
               -  <strong>Desarrollo y Automatización:</strong> Creación de herramientas internas (MS Access, PowerApps, Python, SharePoint, SQL/MySQL) para modernizar operaciones departamentales.<br/>
               -  <strong>Héroe de Ciberseguridad:</strong> Contribución a la recuperación de más de 100 computadoras en 8 días tras ataque de malware usando SCCM.<br/>
               ...
               -  <strong>Soporte e Infraestructura:</strong> Administración de servidores Windows Server, Active Directory y migración de dominios corporativos con cero tiempo de inactividad.
             </div>
          </div>
